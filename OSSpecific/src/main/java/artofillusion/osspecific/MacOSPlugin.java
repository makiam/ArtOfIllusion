 ...
 */
public class MacOSPlugin extends PluginBase {
    ...
    /**
     * Remove a menu item from a menu in a window. If it is immediately preceded
     * by a separator, also remove that.
     */
    ...
    /**
     * This is an inner class used to provide a minimal menu bar when all
     * windows are closed.
     */
